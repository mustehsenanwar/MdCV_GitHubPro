...
urlpatterns = [
    ...
    path('template_selection/', orderprocessing_dash_views.TemplateSelection.as_view(template_name = 'dashboard/orderprocessing_templates/template_selection.html'), name='template_selection'),
